...
const TARGETS = [
  ...
  { book: "Фонбет (полный фид)", host: "line-static01.bkfon-resources.com", path: "/line/currentLine/ru/0.json" },
  { book: "Фонбет (полный фид)", host: "line11.bkfon-resources.com", path: "/line/currentLine/ru/0.json" },
  { book: "Фонбет (платформа, прематч)", host: "line-lb61-w.bk6bba-resources.com", path: "/ma/events/listBase?lang=ru&scopeMarket=1600" },
  { book: "Фонбет (платформа, лайв)", host: "line51w.bk6bba-resources.com", path: "/events/list?lang=ru&scopeMarket=1600" },
  { book: "Лига Ставок (API витрины)", host: "lds-api-sites.ligastavok.ru", path: "/rest/events/v8/eventsList" },
  { book: "Лига Ставок (сайт)", host: "www.ligastavok.ru", path: "/" },
  { book: "Леон (прематч)", host: "leon.ru", path: "/api-2/betline/events/prematch?ctag=ru-RU" },
  { book: "Леон (лайв)", host: "leon.ru", path: "/api-2/betline/events/inplay?ctag=ru-RU" },
  { book: "Олимп (прематч)", host: "www.olimp.bet", path: "/api/v4/0/line/sports-with-competitions-with-events?vids%5B%5D=" },
  { book: "Олимп (лайв)", host: "www.olimp.bet", path: "/api/v4/0/live/sports-with-competitions-with-events?vids%5B%5D=" },
  { book: "Марафон (платформа, прематч)", host: "line51.tf39be-resources.com", path: "/events/listBase?lang=ru&scopeMarket=3000" },
  { book: "Марафон (платформа, лайв)", host: "line51.tf39be-resources.com", path: "/events/list?lang=ru&scopeMarket=3000" },
  { book: "ПАРИ (платформа, прематч)", host: "line-lb01-w.pb06e2-resources.com", path: "/events/listBase?lang=ru&scopeMarket=2300" },
  { book: "ПАРИ (платформа, лайв)", host: "line01.pb06e2-resources.com", path: "/events/list?lang=ru&scopeMarket=2300" },
  { book: "Беттери (платформа, прематч)", host: "line01.at58f5-resources.com", path: "/events/listBase?lang=ru&scopeMarket=501" },
  { book: "Беттери (платформа, лайв)", host: "line51.at58f5-resources.com", path: "/events/list?lang=ru&scopeMarket=501" },
  { book: "Зенит (фид линии)", host: "zenit.win", path: "/ajax/line/printer/react?all=1&sport=1&length=100&lang_id=1&timezone=3&sort_mode=2" },
];
